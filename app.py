...
card_html = f""" <div class="info-card"> <h3>{title}</h3> <p>{description}</p> </div>
"""
...
airline_html = f""" <div class="airline-card"> <div class="airline-code">{airline_code}</div> <div class="airline-text">Havayolu rehberi</div> </div>
"""
